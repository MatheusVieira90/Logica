...
public class Vetores_14 {
	 ...
	 * 
	 * A) Nome do Aluno; B) Nome e valor da nota maior; C) Nome e valor da menor
	 * nota; D) Média de todas as notas do aluno; E) Se uma ou mais notas principais
	 * menores que 6, informar que aluno foi reprovado, se todas as maiores ou
	 * iguais a 6, informar que aluno foi aprovado.
	 */
